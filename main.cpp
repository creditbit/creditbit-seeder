...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "creditbit-seeder\n"
...
static const string mainnet_seeds[] = {"node1.creditbit.org", "node2.creditbit.org", "node3.creditbit.org", "node4.creditbit.org", "node5.creditbit.org", "node6.creditbit.org", "node7.creditbit.org", "node8.creditbit.org", "node9.creditbit.org", "node10.creditbit.org",""};
static const string testnet_seeds[] = {"node1.creditbit.org",
                                       "node2.creditbit.org",
                                       "node3.creditbit.org",
                                       "node4.creditbit.org",
									   "node5.creditbit.org",
